...
const MediaContextMenu = (0, import_ce_la_react.createComponent)({
  tagName: "media-context-menu",
  elementClass: Modules.MediaContextMenu,
  react: import_react.default,
  toAttributeValue,
  defaultProps: {
    suppressHydrationWarning: true
...
const MediaContextMenuItem = (0, import_ce_la_react.createComponent)({
  tagName: "media-context-menu-item",
  elementClass: Modules.MediaContextMenuItem,
  react: import_react.default,
  toAttributeValue,
  defaultProps: {
    suppressHydrationWarning: true
