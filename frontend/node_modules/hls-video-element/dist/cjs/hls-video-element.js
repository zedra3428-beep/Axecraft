  ...
  return class HlsVideo extends superclass {
    ...
    async load() {
      ...
      if (import_hls.default.isSupported()) {
        ...
        this.api.on(import_hls.default.Events.ERROR, (event, data) => {
          if (data.type === import_hls.default.ErrorTypes.NETWORK_ERROR && data.details === import_hls.default.ErrorDetails.FRAG_LOAD_ERROR) {
            lastFailedLevel = data.frag.level;
          }
        });
        this.api.on(import_hls.default.Events.LEVEL_SWITCHED, (event, data) => {
