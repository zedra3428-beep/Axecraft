...
var media_keyboard_shortcuts_dialog_exports = {};
__export(media_keyboard_shortcuts_dialog_exports, {
  MediaKeyboardShortcutsDialog: () => MediaKeyboardShortcutsDialog,
  default: () => media_keyboard_shortcuts_dialog_default
});
module.exports = __toCommonJS(media_keyboard_shortcuts_dialog_exports);
...
class MediaKeyboardShortcutsDialog extends import_media_chrome_dialog.MediaChromeDialog {
  constructor() {
    super(...arguments);
...
if (!import_server_safe_globals.globalThis.customElements.get("media-keyboard-shortcuts-dialog")) {
  import_server_safe_globals.globalThis.customElements.define("media-keyboard-shortcuts-dialog", MediaKeyboardShortcutsDialog);
}
